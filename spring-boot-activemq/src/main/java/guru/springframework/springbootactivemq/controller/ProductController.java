package guru.springframework.springbootactivemq.controller;

import guru.springframework.springbootactivemq.command.ProductCommand;
import guru.springframework.springbootactivemq.converter.ProductToProductCommand;
import guru.springframework.springbootactivemq.service.ProductService;
...
public class ProductController {
    ...
    public String indexProduct(@PathVariable Long id){
